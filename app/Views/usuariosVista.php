...
<head>
    ...
    <style>
        body {
            background: linear-gradient(135deg, rgba(38, 241, 166, 1), #27dcacff); 
            min-height: 100vh;
            padding: 2rem;
        ...
        .btn-productos {
            ...
            background: linear-gradient(to right, #0fff5bff, #24ff78ff);
            color: white;
        ...
        .btn-productos:hover {
            background: linear-gradient(to right, #0acbbbff, #2dd1e0ff);
